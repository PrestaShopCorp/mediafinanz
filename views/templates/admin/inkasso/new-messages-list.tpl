...
<div class="panel">
    <div class="row">
        <button id="show_new_messages" class="btn btn-default"> <i class="icon-envelope-alt"></i> <span>{l s='New messages' mod='mediafinanz'}</span>
            <span class="badge">
                ...
                <table id="payout_history_table" class="table">
                    ...
                    {foreach $new_messages AS $index => $message}
                        <tr class="{if $message@iteration is odd by 1}odd{/if}">
                            ...
                            <td><a class="btn btn-default" href="{$link->getAdminLink('AdminInkasso')|escape:'html':'UTF-8'}&amp;id_mf_claim={$message.id_mf_claim|escape:'html':'UTF-8'}&amp;viewmf_claims"><i class="icon-search-plus"></i>{l s='View claim' mod='mediafinanz'}</a></td>
                        </tr>
                    {/foreach}
                    <tr class="{if $message@iteration is odd by 1}odd{/if}">
                        <td colspan="6" class="text-center">
                            <a class="btn btn-default" href="{$link->getAdminLink('AdminInkasso')|escape:'html':'UTF-8'}&amp;viewMessages=true">
