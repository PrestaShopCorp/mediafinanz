...
<div class="panel col-lg-12">
    <div class="panel-heading">
        <i class="icon-cogs"></i> {l s='Number of days for last reminder' mod='mediafinanz'}
    </div>
        ...
        {if isset($groupreminder_data)}
            {foreach $groupreminder_data AS $index => $groupreminder}
                <div class="form-group">
                    ...
                    <div class="col-lg-3 ">
                        <input type="text" size="3" name="groupLastReminderDays[{$groupreminder.id_group|escape:'html':'UTF-8'}]" value="{$groupreminder.value|escape:'html':'UTF-8'}" />
                    </div>
                </div>
            {/foreach}
        {/if}
